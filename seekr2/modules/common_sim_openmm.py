...
class Common_sim_openmm:
    ...
    integrator : MmvtLangevinIntegrator() or LangevinIntegrator()
        The Langevin Integrator used to integrate the equations of 
        motion.
...
class Common_sim_openmm_factory:
    """
    ...
    def fill_generic_parameters(self, sim_openmm, model, anchor, 
                                output_filename):
        """
    ...
    def create_openmm_system(self, sim_openmm, model, anchor):
        """
    ...
    def add_barostat(self, sim_openmm, model):
        """
    ...
    def add_platform(self, sim_openmm, model):
        """
