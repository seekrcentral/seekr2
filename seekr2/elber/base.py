...
class Elber_settings(serializer.Serializer):
    ...
    temperature_equil_trajectory_freq : int or None
        The frequency to write trajectory frames during the temperature
    ...
    umbrella_stage_trajectory_freq : int
        The frequency to write trajectory frames during the umbrella
        stage.
    """
...
class Elber_anchor(serializer.Serializer):
    ...
    def __init__(self):
        ...
        self.temp_equil_directory = "temp_equil"
        self.umbrella_directory = "umbrella"
        self.fwd_rev_directory = "fwd_rev"
        self.md_mmvt_output_glob = OPENMM_ELBER_GLOB
        self.name = ""
        self.md = False
        self.endstate = False
