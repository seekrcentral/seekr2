OpenMMVT: An MMVT SEEKR Suite for OpenMM
========================================

:Release: |release|
:Date: |today|

**OpenMMVT** Markovian Milestoning with Voronoi Tesselations (MMVT) in OpenMM 
...
accuracy, but utilizing faster, but more approximate BD for regions of greater intermolecular distance. This way the advantages of each simulation regime is 
augmented and their disadvantages are reduced. The regimes are then combined 
using the theory of MMVT such that the kinetics and thermodynamics of the 
...
.. _Issue Tracker: https://github.com/lvotapka/openmmvt/issues
